...
![dev lambda duration](/static/images/dev-lambda-duration-before.png "dev lambda duration")
...
![new datadog lambda layer](/static/images/datadog-plugin.png "datadog plugin")
...
![flamegraph in datadog](/static/images/flamegraph-datadog.png "flamegraph in datadog")

![flamegraph in xray](/static/images/flamegraph-xray.png "flamegraph in xray")
...
##### Dev
![burst credits - dev](/static/images/burst-credit-balance-dev.png "burst credits - dev")
##### QA
![burst credits - qa](/static/images/burst-credit-balance-qa.png "burst credits - qa")
##### UAT 
![burst credits - uat](/static/images/burst-credit-balance-uat.png "burst credits - uat")
...
![directional example of our efs storage](/static/images/efs-storage-example.png "directional example of our efs storage")
...
![burst to elastic utilization](/static/images/burst-to-elastic-utilization.png "burst to elastic utilization")

dev-ingestor-john-deere-v1-sqs-raw-normalizer invocations resumed after this deploy. 

![dev lambda duration after](/static/images/dev-lambda-duration-after.png "dev lambda duration after")
