...
![dev lambda duration](/static/images/debugging-lambda-timeouts/dev-lambda-duration-before.png "dev lambda duration")
...
![new datadog lambda layer](/static/images/debugging-lambda-timeouts/datadog-plugin.png "datadog plugin")
...
![flamegraph in datadog](/static/images/debugging-lambda-timeouts/flamegraph-datadog.png "flamegraph in datadog")

![flamegraph in xray](/static/images/debugging-lambda-timeouts/flamegraph-xray.png "flamegraph in xray")
...
##### UAT 
![burst credits - uat](/static/images/debugging-lambda-timeouts/burst-credit-balance-uat.png "burst credits - uat")
...
![directional example of our efs storage](/static/images/debugging-lambda-timeouts/efs-storage-example.png "directional example of our efs storage")
...
![burst to elastic utilization](/static/images/debugging-lambda-timeouts/burst-to-elastic-utilization.png "burst to elastic utilization")

dev-ingestor-john-deere-v1-sqs-raw-normalizer invocations resumed after this deploy. 

![dev lambda duration after](/static/images/debugging-lambda-timeouts/dev-lambda-duration-after.png "dev lambda duration after")
