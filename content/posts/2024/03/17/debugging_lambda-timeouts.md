...
![dev lambda duration](/images/debugging-lambda-timeouts/dev-lambda-duration-before.png "dev lambda duration")
...
![new datadog lambda layer](/images/debugging-lambda-timeouts/datadog-plugin.png "datadog plugin")
...
![flamegraph in datadog](/images/debugging-lambda-timeouts/flamegraph-datadog.png "flamegraph in datadog")

![flamegraph in xray](/images/debugging-lambda-timeouts/flamegraph-xray.png "flamegraph in xray")
...
##### QA
![burst credits - qa](/images/debugging-lambda-timeouts/burst-credit-balance-qa.png "burst credits - qa")
##### UAT 
![burst credits - uat](/images/debugging-lambda-timeouts/burst-credit-balance-uat.png "burst credits - uat")
...
![directional example of our efs storage](/images/debugging-lambda-timeouts/efs-storage-example.png "directional example of our efs storage")
...
![burst to elastic utilization](/images/debugging-lambda-timeouts/burst-to-elastic-utilization.png "burst to elastic utilization")

dev-ingestor-john-deere-v1-sqs-raw-normalizer invocations resumed after this deploy. 

![dev lambda duration after](/images/debugging-lambda-timeouts/dev-lambda-duration-after.png "dev lambda duration after")
